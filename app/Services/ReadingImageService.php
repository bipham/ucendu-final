...
//    }
    ...
    public function saveImageToLocal($img_name_no_ext, $img_url, $img_extension, $current_lesson_id) {
        ...
        $filepath = base_path() . '\public\upload\img-feature';
        if (!File::exists($filepath)) {
            File::makeDirectory($filepath, 0777, true, true);
        }
        $filename_img = base_path() . '\public\upload\img-feature\\' . $img_name_save;
        file_put_contents($filename_img, $data);
        $destination = base_path() . '\public\upload\img-feature\\' . $img_name_save;
